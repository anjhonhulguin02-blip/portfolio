...
export default function ProjectCard({ project, isOpen, onToggleCaseStudy }) {
  ...
  return (
    <div className="glass-card rounded-2xl flex flex-col min-w-0 h-full overflow-hidden hover:border-purple-500/30 transition-colors duration-300">
      {project.image && (
        <img
          src={project.image}
        ...
        <div className="pt-6 border-t border-white/5 mt-auto space-y-3">
          <div className="flex items-center gap-3">
            {project.githubUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className={`flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-slate-200 border border-white/10 hover:border-white/20 px-3.5 py-2.5 min-h-11 rounded-xl text-xs font-semibold tracking-wide transition-colors duration-300 ${focusRing}`}
              >
                <GithubIcon />
                GitHub
              </a>
            ...
            {project.liveUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className={`flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-500 text-white font-semibold tracking-wide px-3.5 py-2.5 min-h-11 rounded-xl text-xs shadow-lg shadow-purple-600/20 transition-colors duration-300 ${focusRing}`}
              >
                <ExternalLinkIcon />
                Live Demo
              </a>
          ...
          {cs && (
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-pink-300 border border-pink-500/20 hover:border-pink-500/40 px-3.5 py-2.5 min-h-11 rounded-xl text-xs font-semibold tracking-wide transition-colors duration-300 ${focusRing}`}
            >
              Case Study
